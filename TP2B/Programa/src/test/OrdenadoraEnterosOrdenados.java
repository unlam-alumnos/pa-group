...
public class OrdenadoraEnterosOrdenados {
	
	private final static Integer[] arrayIn = {-3, 0, 1, 2, 3, 4, 5, 6, 15};
	private final static Integer[] arraySorted = {-3, 0, 1, 2, 3, 4, 5, 6, 15};
